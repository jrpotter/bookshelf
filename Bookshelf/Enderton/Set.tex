...
\hyperlabel{sub:exercise-6.7}
  ...
  \begin{proof}
    ...
    \paragraph{($\Leftarrow$)}%
      ...
      TODO: Change equinumerous to just an \equi command instead.
      ...
      Because $B$ is a proper subset of finite set $A$, \nameref{} indicates
        there exist $m, n \in \omega$ with $m < n$ such that
        $\equinumerous{B}{m}$ and $\equinumerous{A}{n}$.
      Define $f' \colon (A - B) \rightarrow (A - \{y\})$ as the
        \nameref{ref:restriction} of $f$ by $A - B$.

      By construction, $\equinumerous{\dom{f'}}{n - m}$ and $\equinumerous{\ran{f'}}{n - 1}$.
