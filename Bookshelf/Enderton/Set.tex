  ...
  \begin{proof}
    ...
    \hyperlabel{par:set-difference-size-ii}
      ...
      \subparagraph{Case 2}%
        ...
        Assume $a \not\in B$.
        Then $B - \{a\} = B$, i.e. $B \approx n$.
        By \eqref{par:set-difference-size-ii-eq1}, there exists a one-to-one
          correspondence $g$ between $(A - \{a\}) - (B - \{a\})$ and $m - n$.
        Thus
          \begin{align*}
            (A - \{a\}) - (B - \{a\})
              & = (A - \{a\}) - B \\
        ...
        Therefore $g \cup \{\tuple{a, m}\}$ is a one-to-one correspondence
          between $A - B$ and $(m - n) + 1$.
        By \nameref{sub:theorem-6a}, $$A - B \equin m - n + 1 \equin m^+ - n.$$
