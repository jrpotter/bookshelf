...
\subsection{\sorry{Set Difference Size}}%
\hyperlabel{sub:set-difference-size}

  \begin{lemma}
    Let $A \approx m$ for some natural number $m$ and let $B \subseteq A$.
    Then $B \approx n$ for some natural number $n$ and $A - B \approx m - n$.
  \end{lemma}
